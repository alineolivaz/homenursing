			...
			<div align="center">
				...
				<ul id="myUL">
				    <div class='testimonials'>
						...
						$result = "SELECT * FROM profissional p INNER JOIN tipo_profissional t ON p.tipo_profissional_idtipo_profissional =
						t.idtipo_profissional WHERE p.nome LIKE '%$buscar%'";
						
						$resultados = mysqli_query($conn, $result);
							
						while($rows_busca = mysqli_fetch_array($resultados)){
							echo "<section><div class='content' align='center'> ";				
														
							echo "<h3>".@$rows_busca['nome']."</h3>";
							echo "".@$rows_busca['descricao_profissional']."";
							echo "<p>".@$rows_busca['registro_profissao']."</p>";
							
							echo "<form action='pag_profissional.php' method='get'>";
							echo "<button type='submit' name='id_usu' class='btn btn-info' value='".@$rows_busca['idprofissional'] ."'>Ver Dados</button>";
                            echo "</form>";
